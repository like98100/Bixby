...
public class EnemyStatus
{
    ...
    public EnemyStatus SetEnemyStatus(EnemyType enemyType, ElementRule.ElementType enemyElement)
    {
        ...
        // 중간보스
            ...
            stat = new EnemyStatus(enemyType, 3002,  500.0f, 40.0f, 30.0f, 5.5f, 2.0f, 15.0f, 50.0f, enemyElement);
        else if (enemyType == EnemyType.WaterBoss)
            stat = new EnemyStatus(enemyType, 3003,  500.0f, 40.0f, 30.0f, 5.5f, 2.0f, 15.0f, 50.0f, enemyElement);
        else if (enemyType == EnemyType.ElectricityBoss)
            stat = new EnemyStatus(enemyType, 3004,  500.0f, 40.0f, 30.0f, 5.5f, 2.0f, 15.0f, 50.0f, enemyElement);
        // 최종보스
        else if (enemyType == EnemyType.FinalBoss)
            stat = new EnemyStatus(enemyType, 3005,  1000.0f, 50.0f, 30.0f, 5.5f, 2.0f, 20.0f, 100.0f, enemyElement);
